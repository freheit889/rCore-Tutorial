...
pub const UART_START_ADDRESS: PhysicalAddress = PhysicalAddress(0x35000000);
...
pub const USER_PROCESS_FRAME_QUOTA: usize = 8;
pub const KERNEL_PROCESS_FRAME_QUOTA: usize = 8;
